const tuitionFees = {
    ...
    "BS in Office Administration": {
        ...
        description: "The Bachelor of Science in Office Administration (BSOA) is a four-year degree program that prepares the students for a career in an outcome-focused and technology rich professional environment. The curriculum is designed to equip its graduates with the professional skills and competencies to meet the dynamic and technological needs of diverse industries and global markets, whether in general business, legal, or medical offices. The BSOA program adheres to the provisions of the Commission on Higher Education (CHED) Memorandum Order No. 19, series of 2017 with the purpose of rationalizing the field of Office Administration. The BSOA program combines courses in office administration, management and technology to prepare the students to assume various general and specialized support, supervisory and managerial positions in the local and global workplace, including self-employment.",
        firstSemester: {
